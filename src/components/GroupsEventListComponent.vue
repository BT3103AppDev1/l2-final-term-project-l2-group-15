        ...
        <div class="event-card">
            ...
            <div class="event-content">
                ...
                <div class="event-details">
                    ...
                    <div v-else>
                        <button class="view-btn-default" @click="viewEvent">View Participants</button>
                        <button class="leave-event-btn" @click="leaveEvent">Leave Event</button>
                        <button class="delete-event-btn" @click="deleteEvent">Delete Event</button>
                    </div>

                    <div v-if="this.showParticipants">
                        <EventParticipants :participants = "this.participants" @close="closeEventParticipants"/>
                    </div>
                </div>
            </div>
        </div>
