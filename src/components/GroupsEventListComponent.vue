<template>
  <div class="event-list-item">
    <div class="event-card">
      ...
      <div v-if="!isMember">
        <button class="join-btn-default" @click="joinEvent(eventobj.EventId)">
          Join Event
        </button>
...
.event-card {
  ...
  box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1),
    0 4px 6px -4px rgba(0, 0, 0, 0.1); /* Soft shadow for depth */
...
.event-card:hover {
  ...
  box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.2),
    0 10px 10px -5px rgba(0, 0, 0, 0.04); /* Deeper shadow on hover for a lifting effect */
}
